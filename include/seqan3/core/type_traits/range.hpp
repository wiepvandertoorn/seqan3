...
//!\cond
    requires !std::input_or_output_iterator<rng_t>
//!\endcond
struct reference2<rng_t>
{
    //!\brief Return the reference2 member definition from the queried type's iterator.
    using type = reference2_t<std::ranges::iterator_t<rng_t>>;
};
